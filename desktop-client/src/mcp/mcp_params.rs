use crate::{
    ...
    world::{
        CreateWorldEvent, LoadWorldEvent,
        world_types::{CurrentWorld, DiscoveredWorlds},
    },
};
...
pub struct MultiplayerMcpParams<'w, 's> {
    ...
    pub world_state_events:
        EventWriter<'w, crate::multiplayer::shared_world::WorldStateReceivedEvent>,
    // PhantomData to use the 's lifetime
    _phantom: std::marker::PhantomData<&'s ()>,
}
...
mod tests {
    ...
    fn test_multiplayer_mcp_params_optional_resources() {
        ...
        world.init_resource::<Events<crate::multiplayer::shared_world::WorldStateReceivedEvent>>();

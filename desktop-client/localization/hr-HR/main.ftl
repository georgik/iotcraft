# Main Menu
menu-enter-world = Uđite u svijet
menu-quit-application = Zatvori aplikaciju
menu-select-world = Odaberite svijet
...
world-unknown-time = Nepoznato

# Inventory and Items
item-grass = Trava
item-dirt = Zemlja
item-stone = Kamen
item-quartz-block = Kvarcni blok
item-glass-pane = Stakleni panel
